...
{
    [RealtimeModel]
    public partial class NCM_PositionMarkerModel
    {
...
namespace com.DU.CE.NET.NCM {
    public partial class NCM_PositionMarkerModel : RealtimeModel {
        ...
        public NCM_PositionMarkerModel() : this(null) {
        }
        
        public NCM_PositionMarkerModel(RealtimeModel parent) : base(null, parent) {
        }
