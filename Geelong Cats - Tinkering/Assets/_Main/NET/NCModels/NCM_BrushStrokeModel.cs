...
{
    [RealtimeModel]
    public partial class NCM_BrushStrokeModel
    {
        [RealtimeProperty(1, true)]
        private RealtimeArray<NCM_RibbonPointModel> _ribbonPoints;
...
namespace com.DU.CE.NET.NCM {
    public partial class NCM_BrushStrokeModel : RealtimeModel {
        ...
        public Normal.Realtime.Serialization.RealtimeArray<com.DU.CE.NET.NCM.NCM_RibbonPointModel> ribbonPoints {
        ...
        public NCM_BrushStrokeModel() : this(null) {
        }
        
        public NCM_BrushStrokeModel(RealtimeModel parent) : base(null, parent) {
            RealtimeModel[] childModels = new RealtimeModel[1];
            
            _ribbonPoints = new Normal.Realtime.Serialization.RealtimeArray<com.DU.CE.NET.NCM.NCM_RibbonPointModel>();
